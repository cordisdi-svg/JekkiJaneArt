  ...
  return (
    <PageBackground backgroundSrc="/mainpage/mainpage-back.webp">
      ...
      <div className="flex h-svh w-full flex-col justify-center items-center overflow-hidden pb-[var(--nav-height-mobile)] lg:pb-[var(--nav-height-desktop)]">
        <div className="relative w-full h-full lg:h-[calc(100vh-var(--nav-height-desktop)-1rem)] max-h-[850px] lg:max-h-[880px] xl:max-h-[960px] 2xl:max-h-[1050px] lg:px-2 lg:py-2">
          <AmuletsCarousel />
        </div>
      </div>
    </PageBackground>
