          ...
          <WallsMarquee>
            <div className="relative w-[78%] sm:w-[500px] md:w-[610px] h-auto flex flex-col justify-center bg-transparent border-none shadow-none md:my-auto shrink-0 z-20 font-comfortaa">
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-6 mb-3 text-[14px] md:text-[19px] leading-[1.2] shrink-0">
                ...
                {/* Right column */}
                <div className="relative before:absolute before:inset-0 before:bg-black/15 before:backdrop-blur-md before:rounded-xl before:border before:border-white/10 before:shadow-xl before:opacity-0 group-data-[visible=true]:before:opacity-100 before:transition-opacity before:duration-[1500ms] before:pointer-events-none p-3 md:p-4 h-full flex flex-col gap-1 md:gap-2">
                  <p className="relative z-10 font-fontatica font-semibold text-[18px] md:text-[24px] text-white/95 border-b border-white/20 pb-1 md:pb-2 w-max leading-none">Этапы:</p>
                  <ul className="relative z-10 list-none flex flex-col gap-[2px] md:gap-[4px] text-white/85">
