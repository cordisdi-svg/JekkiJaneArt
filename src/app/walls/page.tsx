    ...
    <PageBackground backgroundSrc="/mainpage/mainpage-back.png">
      ...
      <div className="font-fontatica relative flex h-[100svh] w-full flex-col items-center justify-center overflow-hidden pb-[var(--nav-height-mobile)] lg:pb-[var(--nav-height-desktop)]">
        ...
        <div className="relative z-10 w-[78%] sm:w-[500px] md:w-[610px] h-auto flex flex-col justify-center bg-transparent border-none shadow-none md:my-auto shrink-0 z-20">
          ...
          <div className="grid grid-cols-2 gap-2 md:gap-6 mb-3 text-[14px] md:text-[18px] leading-[1.2] shrink-0">
            {/* Left column */}
          ...
          {/* Bottom section */}
          <div className="bg-black/15 backdrop-blur-md rounded-xl p-3 md:p-4 flex flex-col gap-2 md:gap-3 text-[14px] md:text-[18px] border border-white/10 shrink-0 mb-auto md:mb-0 shadow-xl leading-[1.2]">
